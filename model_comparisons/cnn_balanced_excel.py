...
def main():
    X_train, X_test, y_train, y_test = get_train_test_data("balanced")
    ...
    df.to_excel("results/CNN_balanced_results.xlsx", index=False)

    print("✅ Saved: results/CNN_balanced_results.xlsx")
